...
namespace ThrownDaggers.Utilities
{
    public static class Helpers
    {
        ...
        public static T CreateBlueprint<T>([NotNull] string name, string assetGuid, Action<T> init = null) where T : SimpleBlueprint, new()
        {
            var result = new T
            {
                name = name,
                AssetGuid = new BlueprintGuid(new Guid(assetGuid))
            };
